    ...
    render() {
        return (
            <div style={{backgroundColor: '#333b65', color: 'white'}}>
                ...
                <div style={{maxWidth: '70%', paddingLeft: '25%'}}>
                    <Header style={{color: 'white'}}>Data Blog Team FAQ</Header>
                    <div style={{textAlign: 'left'}}>
                        <h2>What will I be doing when I join the Data Blog Team?</h2>
                        <p style={{fontSize: '.4em', paddingLeft: "5%"}}>As a data blog member, </p>
                        <ul style={{fontSize: '.4em'}}>
                            <li>
                            <p>You will be developing a data-driven article on any topic throughout each quarter with a team. Check out articles from past teams: https://medium.com/@ucladatares. </p>
                            </li>
                            <li>
                                <p>
                        ...
                        <h2>I don’t have a lot of experience with programming or working with data. Can I still join?</h2>
                        <p style={{fontSize: '.4em', paddingLeft: "5%"}}>Yes! We don’t require in depth experience, but we do require a baseline of knowing a bit of R or Python. In the short answer questions of the app, you can demonstrate your prior knowledge through previous personal projects or coursework that you’ve taken (Ex: Statistics 20).</p>
                        <h2>What does an ideal Data Blog candidate look like?</h2>
                        ...
                        <h2>How competitive is the application process for Data Blog and how can I make my application stand out</h2>
                        <p style={{fontSize: '.4em', paddingLeft: "5%"}}>
                        ...
                        <p style={{fontSize: '.4em', paddingLeft: "5%"}}>
                        We love to see if you have ideas that you want to turn into a project! Bonus points if you can discuss any specific article topics you are interested in analyzing/writing about in your application.
                        </p>
                    </div>
